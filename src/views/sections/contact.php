    ...
    <section>
        <article>
            ...
            ?>">
                ...
                Naam: <input type="text" name="Name" value= "gebruikersnaam1"> </br>
                Email: <input type="text" name="Email" value = "gebruikersmailadres1"> </br>
                Onderwerp:
                <input type="radio" name="Topic" value="Account"> Mijn gegevens
                <input type="radio" name="Topic" value="App"> De applicatie
                <input type="radio" name="Topic" value="Festivals"> Festivals </br>
